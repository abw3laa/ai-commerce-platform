...
export interface CommerceEngine{respond(input:{customerId?:string;conversationId?:string;message:string;language?:string;summary?:string|null;history?:Array<{role:"user"|"assistant";content:string}>;allowOrderCreation?:boolean}):Promise<{reply:string;toolCalls:string[]}>;}
