...
export async function buildApp(env:Env=loadEnv(),deps?:AuthRepositories):Promise<FastifyInstance>{
 ...
 let resolvedDeps:AuthRepositories;let authorizationRepo:AuthorizationRepository|undefined;let productRepo:any;let offerRepo:any;let customerRepo:any;let orderRepo:any;let paymentRepo:any;let shipmentRepo:any;let conversationRepo:any;let categoryRepo:any;let mediaRepo:any;
